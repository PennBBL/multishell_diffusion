...
# Make directory structure
	...
	/share/apps/fsl/5.0.9/bin/eddy_openmp --imain=$out/prestats/topup/${bblIDs}_${SubDate_and_ID}_topup_applied.nii.gz --mask=${topup_mask} --index=/data/joy/BBL/projects/multishell_diffusion/processedData
/index.txt --acqp=$acqp --bvecs=$bvec --bvals=$out/prestats/qa/${bblIDs}_${SubDate_and_ID}_roundedbval.bval --out=$eddy_outdir/${bblIDs}_${SubDate_and_ID}_eddied
