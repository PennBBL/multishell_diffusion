...
subjDataName="/data/joy/BBL/projects/multishell_diffusion/GroupLevelAnalyses/rdsFiles/MDforGam.rds"

OutDirRoot="/data/joy/BBL/projects/multishell_diffusion/GroupLevelAnalyses"  
...
covsFormula="~s(ageatscan,k=4)+sex+bShell_zAvg+ari_total"
...
input="/data/joy/BBL/projects/multishell_diffusion/GroupLevelAnalyses/noddiValues/JLF_ICVF.csv"
