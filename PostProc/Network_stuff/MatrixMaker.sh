...
# Used to create connectivity matrices - scalars weighted onto tractography file
# trunacted version of determtract, as this version does not produce tractography. Use for applying scalars to methods of tractography not equivalent to those generated in determtract.sh
