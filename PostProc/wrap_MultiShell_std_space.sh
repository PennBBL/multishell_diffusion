...
for i in $general;do 
	...
	logDir=/data/joy/BBL/tutorials/exampleData/AMICO_NODDI/Processed_Data/${bblIDs}/${SubDate_and_ID}/logfiles
		...
		var0="pushd /data/joy/BBL/tutorials/code/multishell_diffusion/PostProc; ./ToStandardSpace.sh ${bblIDs} ${SubDate_and_ID}; popd"

		echo -e "${var0}" > ${logDir}/run_MultiShell_stdSpace_"${bblIDs}"_"${SubDate_and_ID}".sh

		subject_script=${logDir}/run_MultiShell_stdSpace_"${bblIDs}"_"${SubDate_and_ID}".sh
