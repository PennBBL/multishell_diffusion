...
FA= "/data/joy/BBL/tutorials/exampleData/AMICO_NODDI/Processed_Data/" + str(bblIDs) + "/" + str(subdate_and_ID) + "/prestats/eddy/" + str(bblIDs) + "_" + str(subdate_and_ID) + "_ssFA.nii.gz"
...
AD=  "/data/joy/BBL/tutorials/exampleData/AMICO_NODDI/Processed_Data/" + str(bblIDs) + "/" + str(subdate_and_ID) + "/prestats/eddy/" + str(bblIDs) + "_" + str(subdate_and_ID) + "_ssAD.nii.gz"

MD=  "/data/joy/BBL/tutorials/exampleData/AMICO_NODDI/Processed_Data/" + str(bblIDs) + "/" + str(subdate_and_ID) + "/prestats/eddy/" + str(bblIDs) + "_" + str(subdate_and_ID) + "_ssMD.nii.gz"
...
RD= "/data/joy/BBL/tutorials/exampleData/AMICO_NODDI/Processed_Data/" + str(bblIDs) + "/" + str(subdate_and_ID) + "/prestats/eddy/" + str(bblIDs) + "_" + str(subdate_and_ID) + "_ssRD.nii.gz"
...
with open('/home/apines/cors_6_19_replicate_ss.csv','a') as fd:
    fd.write(myCsvRow)
